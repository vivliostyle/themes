...
BREAKING CHANGE: `css/utility-classes.css` no longer exists, and `theme-all.css` (as well as `@vivliostyle/theme-slide`) no longer imports it. Remove the import, and replace each class with a rule that declares the property.
