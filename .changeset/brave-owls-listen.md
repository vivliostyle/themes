...
BREAKING CHANGE: `@vivliostyle/cli` **11.3.0 or later** is required (previously `>=7`, or `>=8` for `theme-epub3j`). The stylesheets use CSS Nesting and import `@vivliostyle/theme-base` by its npm package name through the package `exports` field, which CLI 11.3.0 added. The scaffold generated by `create-vivliostyle-theme` declares the same range.
