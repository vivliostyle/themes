...
- [#158](https://github.com/vivliostyle/themes/pull/158) [`e3bb168`](https://github.com/vivliostyle/themes/commit/e3bb1681c72df4d869c54813ffdbb0ca4d2c83c6) Thanks [@spring-raining](https://github.com/spring-raining)! - Vivliostyle Themes v3: `@vivliostyle/theme-base` becomes a set of opt-in modules imported by npm package name, and its custom properties are renamed to match the CSS properties they control and extended to cover what used to need plain CSS.
