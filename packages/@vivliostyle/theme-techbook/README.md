...
This theme imports [`theme-okaidia`](../theme-base/css/prism/theme-okaidia.css) as a default color theme of code blocks. If you want to use other themes, please import the CSS like this.
