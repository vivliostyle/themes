...
This theme imports [`theme-prism`](../theme-base/css/prism/theme-prism.css) as a default color theme of code blocks. If you want to use other themes, please import the CSS like this.
